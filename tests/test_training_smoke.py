...
from rl_connect4.envs.pettingzoo_connect4 import PettingZooConnect4GymEnv, random_legal_policy
...
def test_short_training_smoke():
    ...
    model = MaskablePPO(
        ...
        batch_size=64,
        learning_rate=3e-4,
        policy_kwargs={"features_extractor_class": Connect4CNNExtractor},
        verbose=0,
    )
